...
class AppLocalizations {
  ...
  Future<bool> load() async {
    ...
    var jsonString = await rootBundle.loadString(
        '${LanguageManager.instance.assetsPathLanguage}/${locale.languageCode}_${locale.countryCode}.json');
    debugPrint(
        'Dil dosyaları "${LanguageManager.instance.assetsPathLanguage}" dosya yolundan OKUNDU.');
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) {
    ...
    return LanguageManager.instance.supportedLanguagesCode
  ...
  Future<AppLocalizations> load(Locale locale) async {
    ...
    debugPrint(
        'Dil dosyaları "${LanguageManager.instance.assetsPathLanguage}" dosya yolundan YÜKLENDİ.');
